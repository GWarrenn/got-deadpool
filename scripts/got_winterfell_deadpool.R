...
## Description: Game of Thrones Deadpool
## Date: 5/14/2019
## Status: Published
...
write.csv(export_predictions_long,file = "C:\\users\\augus\\desktop\\predictions.csv")
...
write.csv(export_outcomes,file = "C:\\users\\augus\\desktop\\outcome_table.csv")
